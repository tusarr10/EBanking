...
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div class="card ">
        <div class="card-body ">
            ...
            <button type="button" class="collapsible1">CIF Information</button>
            <div class="content">
            ...
            <button type="button" class="collapsible1">Mode Of Operation</button>
            <div class="content">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
            ...
            <button type="button" class="collapsible1">Product Information</button>
            ...
            <button type="button" class="collapsible1">Nomini Information</button>
