<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Official/official.Master" CodeBehind="sbWithdraw.aspx.vb" Inherits="TWEB.sbWithdraw" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <label>Withdraw SB Account</label>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <label>Jont Name</label>
                    <div class="form-group">
                        <div class="input-group">
                            <asp:TextBox CssClass="form-control mr-1" ID="nametb2" runat="server" placeholder="Name " ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
