...
Public Class sbjournaltrns
    ...
    Private JournalData As sbJournalClass
    ...
    Private Sub InsertDataIntoSqltransctiondb(i As Integer)
        ...
        Dim x As Integer
        For x = 0 To i - 1
            JournalData = New sbJournalClass
            ...
            End If
            JournalData.amount = ASPxGridView1.GetSelectedFieldValues("transAmt")(x).ToString
            JournalData.bat = ASPxGridView1.GetSelectedFieldValues("AcBal")(x).ToString
            ...
            ASPxMemo1.Text = logmsg
            UPN1.Update()
            If Not DataService.IsTridExistInsbJournal(JournalData.trid) Then
                'TODO if transction Not Available then Insert Data
                Dim ii As Boolean
                ii = DataService.addToSbjournal(JournalData)
                If ii Then
                    z += 1
            ...
            Else
                ...
                Dim iii As Boolean
                If Not DataService.IsDataExistInSB(JournalData) Then
                    'todo if data duplicate not found then do Insert Data
                    iii = DataService.addToSbjournal(JournalData)
                    If iii Then
                        z += 1
