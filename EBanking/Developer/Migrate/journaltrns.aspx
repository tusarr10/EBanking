<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Developer/Developer.Master" CodeBehind="journaltrns.aspx.vb" Inherits="TWEB.journaltrns" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div class="card ">
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" ClientInstanceName="gridView" EnablePagingGestures="False" CssClass="grid-view" Width="100%" OnCustomCallback="GridView_CustomCallback" KeyFieldName="remark;d_ate;accountNumber" AutoGenerateColumns="False">
            <Columns>
            ...
            <Columns>
                <dx:GridViewDataTextColumn Caption="Date" VisibleIndex="1" FieldName="d_ate" Name="da_te"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="AccountType" VisibleIndex="2" FieldName="AccountType" Name="AccountType"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="AccountNumber" VisibleIndex="3" FieldName="accountNumber" Name="accountNumber"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Name" VisibleIndex="4" FieldName="AccountHolderName" Name="AccountHolderName"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Deposit" VisibleIndex="5" FieldName="deposit" Name="deposit"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Withdraw" VisibleIndex="6" FieldName="withdrow" Name="withdrow"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Balance" VisibleIndex="7" FieldName="balance" Name="balance"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Dlt" VisibleIndex="8" FieldName="DLT" Name="DLT"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Remark" VisibleIndex="9" FieldName="remark" Name="remark"></dx:GridViewDataTextColumn>
            </Columns>
